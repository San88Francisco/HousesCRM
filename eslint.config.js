...
export default [
  {
    ignores: [
      ...
      '**/package-lock.json',
      '**/package.json',
      '**/*.js',      // Ігноруємо всі JS файли
      '**/*.jsx',     // Ігноруємо всі JSX файли
    ],

    files: ['**/*.{ts,tsx}'],
    excludedFiles: ['**/.next/**', '**/node_modules/**', '**/dist/**', '**/build/**'],
    ...
    rules: {
      ...
      'no-restricted-syntax': [
        'error',
        {
          ...
          message: 'Використовуйте стрілкові функції, крім export default function',
        },
      ],
