...
const switchRoot = cva(
  'peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent ' +
    'bg-gray-100 dark:bg-gray-700 transition-colors duration-400 ease-in-out ' +
...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root ref={ref} className={cn(switchRoot(), className)} {...props}>
    <SwitchPrimitives.Thumb className={cn(switchThumb())} />
