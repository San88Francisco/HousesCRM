                  ...
                  {formatter && item?.value !== undefined && item.name ? (
                    ...
                    <>
                      ...
                      >
                        <div className="grid gap-1.5">
                          {nestLabel ? tooltipLabel : null}
                          <span className="text">{itemConfig?.label || item.name}&nbsp;</span>
                        </div>
                        {item.value && <span className="text">{item.value.toLocaleString()}₴</span>}
                      </div>
                    </>
                  )}
                </div>
